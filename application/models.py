...
class student(schooldb.Model):
    ...
    student_id = schooldb.Column(schooldb.String(10),unique=True )
...
class moodle(schooldb.Model):
    ...
    moodle_id = schooldb.Column(schooldb.String(10))
    moodleName = schooldb.Column(schooldb.String(45))
    student_id = schooldb.Column(schooldb.String(10), schooldb.ForeignKey('student.student_id'), nullable=False)
